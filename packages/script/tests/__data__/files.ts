import { ContentsApiResponse } from "../../get-subsets";
...
MOCK_FILE_INFO[`${CACHE_DIR}/slices/korean_default.txt`] = `# Generated by a tool; DO NOT MODIFY BY HAND
...
`;
MOCK_FILE_INFO[
	`${CACHE_DIR}/slices/traditional-chinese_default.txt`
...
`;
MOCK_FILE_INFO[`${CACHE_DIR}/slices/japanese_default.txt`] = `# Generated by a tool; DO NOT MODIFY BY HAND
...
`;
MOCK_FILE_INFO[
	`${CACHE_DIR}/subsets/latin_unique-glyphs.nam`
...
`;
MOCK_FILE_INFO[
	`${CACHE_DIR}/subsets/cyrillic_unique-glyphs.nam`
] = `# This file was generated by preprocess_namfile.py
...
`;
MOCK_FILE_INFO[
	`${CACHE_DIR}/subsets/chinese-traditional_unique-glyphs.nam`
] = `# This file was generated by preprocess_namfile.py
	...
	if (url.includes("/gfsubsets/")) {
		files.push(
			...Object.keys(MOCK_FILE_INFO)
				...
				.map((filePath) => ({ name: path.basename(filePath), download_url: "#", type: "file" }))
		);
